...
public class FileTool implements ViewTool {
	...
	/**
	 * MLH added method. 
	 * Allows us to easily retrieve a File's Folder.
	 * @param file
	 * @return
	 */
	public Folder getFileFolder(File file) {
		Folder folder = null;
		try {
			...
			folder = fileAPI.getFileFolder(file, host, user, false);			
		} catch (DotDataException e) {
			e.printStackTrace();
		} catch (DotSecurityException dse) {
			Logger.error(FileTool.class,dse.getMessage(),dse);
		}
		return folder;
	}
