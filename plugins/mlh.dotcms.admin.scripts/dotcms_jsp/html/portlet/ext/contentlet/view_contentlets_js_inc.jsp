        ...
        for(i = 0;i< cbCount ;i++){
            if (cbArray[i].checked) {
                ...
                if (dijit.byId('archiveButton')) {
					fieldArray.push(dijit.byId('archiveButton').setAttribute("disabled", false));
				}
				if (dijit.byId('publishButton')) {
					fieldArray.push(dijit.byId('publishButton').setAttribute("disabled", false));
				}
				if (dijit.byId('unPublishButton')) {
					fieldArray.push(dijit.byId('unPublishButton').setAttribute("disabled", false));
				}
				if (dijit.byId('unlockButton')) {
					fieldArray.push(dijit.byId('unlockButton').setAttribute("disabled", false));
				}
				if (dijit.byId('reindexButton') && <%=canReindex%>) {
					fieldArray.push(dijit.byId('reindexButton').setAttribute("disabled", false));
				}
            ...
            if (showArchive) {
				...
				if (dijit.byId('archiveButton')) {
					fieldArray.push(dijit.byId('archiveButton').setAttribute("disabled", true));
				}
				if (dijit.byId('publishButton')) {
					fieldArray.push(dijit.byId('publishButton').setAttribute("disabled", true));
				}
				if (dijit.byId('unPublishButton')) {
					fieldArray.push(dijit.byId('unPublishButton').setAttribute("disabled", true));
				}
				if (dijit.byId('unlockButton')) {
					fieldArray.push(dijit.byId('unlockButton').setAttribute("disabled", true));
				}
				if (dijit.byId('reindexButton') && <%=canReindex%>) {
					fieldArray.push(dijit.byId('reindexButton').setAttribute("disabled", true));
				}
