...
<%
	if (request.getAttribute("wysiwygFieldExists") != null) {
		String fieldExistsValue = (String)request.getAttribute("wysiwygFieldExists");
		String inlineLinkIncluded = (String)request.getAttribute("inlineLinkIncluded");
		if ("true".equals(fieldExistsValue) && !"true".equals(inlineLinkIncluded)) {
			request.setAttribute("inlineLinkIncluded", "true");
			%>
				<script type="text/javascript" src="/html/js/dotcms/mlh-utils/js/json2.js"></script>
				<%--
				   	MLH inline link tool - uses existing jquery which is set/loaded from edit_contentlet_js_inc.jsp
				--%>
				<script type="text/javascript" src="/html/js/dotcms/mlh-utils/js/inline-link-tool.js"></script>
			<%
		}
