...
<%-- 
 MLH addition : add jQuery with noConflict
--%>
<script type="text/javascript" src="/html/js/dotcms/mlh-utils/js/jquery-1.6.1.min.js"></script>
<script type="text/javascript" src="/html/js/dotcms/mlh-utils/js/mlhNoConflict.js"></script>
